...
# 假设保存的模型参数文件名为'model_weights.pth'
...
# # 打印 mambavision 模型参数的 requires_grad 状态
# print("mambavision 模型参数的 requires_grad 状态：")
# for name, param in mambavision.named_parameters():
#     print(f"{name}: {param.requires_grad}")
#
# # 打印 TabTransformer 模型参数的 requires_grad 状态
# print("\nTabTransformer 模型参数的 requires_grad 状态：")
# for name, param in TabTransformer.named_parameters():
#     print(f"{name}: {param.requires_grad}")
